    ...
    <main style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      <div className="signin-card">
        <div className="signin-card__brand">
          <h1 className="signin-card__logo">The Hospitality Guild</h1>
          <p className="signin-card__tagline">Fide et Hospitalitate</p>
        </div>
        <h2 className="signin-card__heading">Sign in to your account</h2>
        <p className="signin-card__sub">Access your training, community, and resources.</p>
